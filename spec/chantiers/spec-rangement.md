...
| C2 bis `rafraichir` reprend une fusion de `main` résolue à la main (premier parent = révision attendue, second = `main`) ; test de reprise ; preuve réelle sur orchestration | M (Sonnet, effort moyen) | à faire | |
