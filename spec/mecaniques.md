...
1. **Vitesse de combat** — `⌈ base × (1 + Σ%vit) + Σvit_plate ⌉ × Slow × BuffVit`.
...
4. **Facteur de défense** — `1000 / (1140 + 3.5 × DEF)` (aligné wiki fandom), def break ×0.3, ignore def (plancher ≈ 0,877).
5. **Coups critiques** — taux vs dégâts crit ; glancing ne crit pas.
6. **Variance** — ±2.8 % (stats), ±2.35 % (PV max).
