    ...
    <div className="space-y-3 rounded-lg border border-border bg-panel2 p-3">
              ...
              <div key={`effet-cible-monstre-${bonusParEffetCibleMonstre.skillCom2usId}`}>
                ...
                <label className="mt-1 flex items-center gap-2">
                  ...
                  <NumberField
                    ...
                    min={0}
                    max={bonusParEffetCibleMonstre.maxCount}
                    boxWidth="w-24"
      ...
      <div>
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
          ...
          {resolved.bonusParEffetCible && (
            <label className="flex items-center gap-2">
              ...
              <NumberField
                ...
                max={resolved.bonusParEffetCible?.maxCount}
                onChange={(v) =>
                  maj({
          ...
          {(utilise('Relative SPD') || utilise('Target SPD') || critSiPlusRapide || bonusDegatsSelonVit) && (
            <>
              <label className="flex items-center gap-2">
