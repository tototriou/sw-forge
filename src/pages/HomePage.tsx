  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="pt-4">
      ...
      <motion.section variants={item} id="features" className="py-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5">
          <Feature href="#/rta" icon={Swords} accent="#A15FE0" kicker="RTA" title="Préparation RTA" body="Classe ta box par set en glisser-déposer, lis l'ordre de tour recalculé selon les leads, et partage ta prépa avec tes amis." />
