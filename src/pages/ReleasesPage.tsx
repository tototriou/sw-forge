    ...
    <div className="pt-6">
      ...
      <p className="text-ink-dim text-[14px] leading-relaxed mb-6 max-w-2xl">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-1 text-[#8b92e0] hover:text-ink transition"
        >
        ...
        {RELEASES.map((r, i) => (
          <section
            ...
            className={`rounded-2xl border p-4 ${
              ...
              i === 0 ? 'border-[#4a52a0] bg-panel2/50' : 'border-border bg-panel/50'
            }`}
          >
            <div className="flex items-baseline gap-2.5 flex-wrap mb-1">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="ml-auto font-mono text-[11px] text-ink-dim hover:text-ink transition"
              ...
              {[...r.changes]
                ...
                .map((c, k) => (
                  <li key={k} className="flex flex-wrap items-baseline gap-x-2 gap-y-0.5 text-[13px]">
                    <span
                      className={`font-mono text-[10px] uppercase tracking-[0.08em] ${CHANGE_META[c.kind].color}`}
                    >
